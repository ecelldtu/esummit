        ...
        <div className="size-full w-full flex my-40 flex-col items-center justify-center overflow-hidden pt-8 mt-[100vh] text-center">
            ...
            <BoxReveal boxColor={"#5046e6"} duration={0.5}>
                <h2 className="mt-[.5rem] text-[1rem] font-Darker text-[#fff] max-w-[80%] mx-auto text-xl md:text-3xl md:max-w-[60%] text-center font-semibold">
                    E-Cell DTU presents its annual flagship event E-SUMMIT'25 One of the biggest Entrepreneurship summits in India, E-Summit will bring to you a series of enthralling events. from panel discussions with distinguished dignitaries.to exciting competitions like B-plan.
