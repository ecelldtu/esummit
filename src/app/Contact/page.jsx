    ...
    return (
        <>
            <div
                ...
                <h2 className="text-center mx-auto text-4xl my-12 md:text-6xl font-Kalamayka text-white font-bold">
                    Any doubts ?
                </h2>
                <form ref={form} onSubmit={sendEmail} className="w-screen mx-auto ml-2 md:ml-0 text-white -mt-2 relative font-Kalamayka">
                    <div className="flex flex-row w-full items-center pt-10 mx-auto justify-center bg-none rounded-xl md:rounded-l-lg md:rounded-none relative z-10">
                        <div className="w-screen relative flex flex-col md:flex-row justify-around mr-4 md:mr-0">
                            <div className="relative my-8 mx-4">
                                <p className="pt-0 text-xl pr-2 pb-4 pl-2 -mt-3 mr-0 mb-0 ml-2 text-white font-semibold font-Kalamayka absolute -top-4">Name</p>
                            ...
                            <div className="relative my-8 mx-4">
                                <p className="pt-0 text-xl pr-2 pb-4 pl-2 -mt-3 mr-0 mb-0 ml-2 text-white font-semibold font-Kalamayka absolute -top-4">Email</p>
                            ...
                            <div className="relative my-8 mx-4">
                                <p className="pt-0 text-xl pr-2 pb-4 pl-2 -mt-3 mr-0 mb-0 ml-2 text-white font-semibold font-Kalamayka absolute -top-4">Query</p>
                            ...
                            <div className="relative my-8 mx-4">
                                <button type="submit" value="Send" onClick={sendEmail} className="w-full inline-block pt-4 pr-5 pb-4 pl-5 text-xl font-medium text-center text-white bg-violet-600 font-Kalamayka rounded-lg transition duration-200 hover:bg-violet-900 md:mt-2 ease">Submit</button>
                            </div>
                        </div>
                    </div>
                </form>
                <div className="md:mx-10 mx-6 text-lg xl:mx-20 text-white font-Kalamayka">
