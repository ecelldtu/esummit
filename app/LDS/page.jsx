    ...
    return (
        <>
            <motion.div ref={ref}
                ...
                <h1 className='text-center text-4xl mt-16 md:mt-32 md:mb-12 md:text-7xl xl:text-8xl w-full text-white py-4 font-CyberGraph'>LDS PANEL-1</h1>
                ...
                <h1 className='text-center text-4xl mt-16 md:mt-32 md:mb-12 md:text-7xl xl:text-8xl w-full text-white py-4 font-CyberGraph'>LDS PANEL-2</h1>
                <div className="container mx-auto p-4">
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                        {Dep.map((person, index) => (
                            <div key={index} className="max-w-sm rounded overflow-hidden shadow-lg mx-auto">
