...
function Navbar({navLinkId, scrollToId}) {
  ...
  return (
    ...
    <nav className=" border-gray-200 px-2 flex flex-wrap items-center justify-between mx-auto sm:px-4 py-2.5 rounded dark:bg-gray-900">
...
function Dropdown() {
  return (
    ...
    <div className="flex justify-end">
      <ul className=" absolute ease-in duration-200 bg-pink py-1 px-1 leading-tight  rounded border-radius-90%  text-base z-10 list-none divide-y divide-gray-100 shadow ">
     {options.map((val) => {
          return (
            <li 
            activeClass="active"
